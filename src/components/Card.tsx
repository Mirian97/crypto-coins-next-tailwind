...
const Card = ({ name, image, currentValue, currentPercentage, symbol }: CardProps) => (
  <div className='bg-white rounded-2xl p-4 flex-column cursor-pointer transition duration-500 hover:-translate-y-1.5'>
    ...
    <h2 className='font-bold text-xl'>{formatNumberToMoney(currentValue)}</h2>
